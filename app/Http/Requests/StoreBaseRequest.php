...
class StoreBaseRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'national_health_registration' => ['required', 'string', 'max:40', 'unique:bases,national_health_registration'],
    ...
    public function messages(): array
    {
        return [
            ...
            'regional_group_id.required' => 'O grupo regional é obrigatório.',
            'regional_group_id.exists' => 'O grupo regional deve existir.',
        ];
    }
}
