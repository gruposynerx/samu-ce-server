...
class StoreUserRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'national_health_card' => ['nullable', 'string', 'max:16', 'cns'],
            'birthdate' => ['required', 'date'],
            'gender_code' => ['required', 'string', new Enum(GenderCodeEnum::class)],
            'email' => ['required', 'string', 'email', 'max:255', 'unique:users,email'],
            'identifier' => ['required', 'string', 'max:11', 'cpf', 'unique:users,identifier'],
            ...
            'council_number' => ['sometimes', 'string', 'nullable', 'max:50'],
            'cbo' => ['required', 'string', 'max:10'],
            'password' => ['required', 'string', 'confirmed', 'min:8', 'regex:/[!@#$%^&*(),.?":{}|<>]/', 'regex:/[A-Z]/', 'regex:/[0-9]/'],
            'password_confirmation' => ['required', 'string', 'min:8', 'regex:/[!@#$%^&*(),.?":{}|<>]/', 'regex:/[A-Z]/', 'regex:/[0-9]/'],
    ...
    public function messages(): array
    {
        return [
            ...
            'identifier.cpf' => 'O campo CPF deve ser um CPF válido.',
            'identifier.unique' => 'Já existe um usuário cadastrado com esse CPF.',
            ...
            'password.regex' => 'O campo senha deve conter pelo menos uma letra maiúscula, um número e um caractere especial.',
            ...
            'password_confirmation.regex' => 'O campo confirmação de senha deve conter pelo menos uma letra maiúscula, um número e um caractere especial.',
